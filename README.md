...
3. In the Codespaces IDE, follow prompts to install the `Python Extension Pack`. Now you can run the program, try to see how the code works, and experiment with it!
